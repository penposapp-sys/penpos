...
export const listByTenantAndBranch = (tenantId, branchId) =>
  CanteenCategory.find({ tenantId, branchId, isActive: true }).sort({ createdAt: -1 })
...
export const softDeleteByIdAndScope = (id, tenantId, branchId) =>
  CanteenCategory.findOneAndUpdate({ _id: id, tenantId, branchId }, { isActive: false }, { new: true })
