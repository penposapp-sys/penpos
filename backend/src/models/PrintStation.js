...
const stationPrinterSchema = new mongoose.Schema(
  {
    ...
    receiptRole: { type: String, enum: ['cashier', 'kitchen'], default: 'cashier' },
    useForCashierReceipt: { type: Boolean, default: null },
    useForKitchenReceipt: { type: Boolean, default: null },
