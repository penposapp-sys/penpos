...
router.get('/package-orders/online-pending-count', requireAuth, tenantGuard, branchListGuard, requireRole(['tenant_admin', 'staff']), requireAnyPermission(['package_courier_page_view', 'package_orders_view', 'view_delivery', 'manage_delivery']), packageCourierCtrl.getPendingOnlineOrdersCount)
