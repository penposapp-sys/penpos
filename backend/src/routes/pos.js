...
router.put('/orders/:id/entry-date', requireAuth, tenantGuard, resolveBranchFromOrder, branchGuard, requireRole(['tenant_admin', 'staff']), requirePermission(['pos_access']), ctrl.setOrderEntryDate)
...
router.get('/package-orders', requireAuth, tenantGuard, branchListGuard, requireRole(['tenant_admin', 'staff']), requireAnyPermission(['package_courier_page_view', 'package_orders_view', 'manage_delivery', 'package_assign_courier']), packageCourierCtrl.listPackageOrders)
router.get('/package-orders/online-pending-count', requireAuth, tenantGuard, branchListGuard, requireRole(['tenant_admin', 'staff']), requireAnyPermission(['package_courier_page_view', 'package_orders_view', 'manage_delivery', 'package_assign_courier']), packageCourierCtrl.getPendingOnlineOrdersCount)
router.get('/package-orders/:id', requireAuth, tenantGuard, resolveBranchFromOrder, branchGuard, requireRole(['tenant_admin', 'staff']), requireAnyPermission(['package_courier_page_view', 'package_orders_view', 'manage_delivery', 'package_assign_courier']), packageCourierCtrl.getPackageOrderDetail)
router.post('/package-orders/:id/approve-online', requireAuth, tenantGuard, resolveBranchFromOrder, branchGuard, requireRole(['tenant_admin', 'staff']), requireAnyPermission(['manage_delivery', 'package_status_update']), packageCourierCtrl.approveOnlinePackageOrder)
router.post('/package-orders/:id/cancel-online', requireAuth, tenantGuard, resolveBranchFromOrder, branchGuard, requireRole(['tenant_admin', 'staff']), requireAnyPermission(['manage_delivery', 'package_status_update']), packageCourierCtrl.cancelOnlinePackageOrder)
router.post('/package-orders/:id/approve-cancel-request', requireAuth, tenantGuard, resolveBranchFromOrder, branchGuard, requireRole(['tenant_admin', 'staff']), requireAnyPermission(['manage_delivery', 'package_status_update']), packageCourierCtrl.approveOnlineCancelRequest)
