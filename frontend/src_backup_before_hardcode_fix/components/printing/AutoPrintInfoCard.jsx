...
export default function AutoPrintInfoCard({ busy, status, printerCount, hostname, version, lastSeenSec, onReload, error, hint }) {
    ...
    <div className="card" style={{ display: 'grid', gap: 10 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
        <div>
          ...
          <div style={{ fontSize: 13, color: 'var(--muted)' }}>Otomatik yazdırma için bu bilgisayarda PenPOS Print Agent çalışmalıdır.</div>
