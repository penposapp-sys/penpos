...
const TEXT = {
  ...
  successHelp: 'Sipariş sistemde Online Siparişler sayfasına düştü.',
  orderNo: 'Sipariş No',
  ...
  loginNote: 'Mevcut hesapta sadece telefon ve şifre ile giriş yapılır. Başarılı girişte eski online siparişler ve cari borç durumu görünür.',
  ...
  noOldOrders: 'Eski online sipariş bulunamadı.',
  ...
  loading: 'Online sipariş sayfası yükleniyor...',
  loadError: 'Online sipariş sayfası açılmadı',
  phone: 'Telefon',
  whatsapp: 'WhatsApp',
  email: 'E-posta',
  address: 'Adres',
...
const MOJIBAKE_REPLACEMENTS = [
  ...
  ['QR sipari\u00c5\u0178 sayfas\u00c4\u00b1 a\u00c3\u00a7\u00c4\u00b1lamad\u00c4\u00b1', 'Online sipariş sayfası açılamadı'],
  ['QR sipariÃ…Å¸ sayfasÃ„Â± aÃƒÂ§Ã„Â±lamadÃ„Â±', 'Online sipariş sayfası açılamadı'],
  ['Sipari\u00c5\u0178', 'Sipari\u015f'],
  ['SipariÃ…Å¸', 'Sipariş'],
  ['\u00c3\u015cr\u00c3\u00bcn', '\u00dcr\u00fcn'],
  ['ÃƒÅ“rÃƒÂ¼n', 'Ürün'],
  ...
  ['QR sipari\u00c5\u0178 sayfas\u00c4\u00b1 y\u00c3\u00bckleniyor...', 'Online sipariş sayfası yükleniyor...'],
  ['QR sipariÃ…Å¸ sayfasÃ„Â± yÃƒÂ¼kleniyor...', 'Online sipariş sayfası yükleniyor...'],
  ['\u00c4\u00b0leti\u00c5\u0178im', '\u0130leti\u015fim'],
  ...
  ['Sipari? sistemde QR Sipari?leri sayfas?na d??t?.', 'Sipariş sistemde Online Siparişler sayfasına düştü.'],
  ...
  ['Eski QR sipari\u00c5\u0178i bulunamad\u00c4\u00b1.', 'Eski online sipariş bulunamadı.'],
  ['Eski QR sipariÃ…Å¸i bulunamadÃ„Â±.', 'Eski online sipariş bulunamadı.'],
  ['?r?n Detay?', '\u00dcr\u00fcn Detay\u0131'],
  ['HesabÃ„Â±m', 'Hesabım'],
  ['Mağaza ?r?n?', 'Mağaza Ürünü'],
        ...
        <main className="qr-ref-content">
          ...
          {view === 'success' ? (
            <section className="qr-ref-panel qr-ref-success">
              ...
              <p className="qr-ref-muted">Sipariş sistemde Online Siparişler sayfasına düştü.</p>
